...
$uid = $user_profile['field_user_name']['#object']->uid;
$name = $user_profile['field_user_name'][0]['#markup'];
$url = 'user/' . $uid;
$link = l($name, $url, array('attributes' => array('class' => array('collaborator-name'))));
print render($link);
